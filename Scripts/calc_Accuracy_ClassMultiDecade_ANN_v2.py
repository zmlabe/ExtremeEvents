...
np.savetxt(directorydata + 'train_totalaccuracy_ClassMultiDecade_ANNv2_%s.txt' % dataset,
            np.array([acctrain]))
np.savetxt(directorydata + 'test_totalaccuracy_ClassMultiDecade_ANNv2_%s.txt' % dataset,
            np.array([acctest]))

periodtrain = accuracyTPeriodTime(indextrain,classesl)
periodtest = accuracyTPeriodTime(indextest,classesl)
np.savetxt(directorydata + 'train_periodaccuracy_ClassMultiDecade_ANNv2_%s.txt' % dataset,
            periodtrain)
np.savetxt(directorydata + 'test_periodaccuracy_ClassMultiDecade_ANNv2_%s.txt' % dataset,
            periodtest)