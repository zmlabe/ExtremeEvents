...
np.savetxt(directorydata + 'train_totalaccuracy_ClassCentury_ANNv1.txt',
           acctrain)
np.savetxt(directorydata + 'test_totalaccuracy_ClassCentury_ANNv1.txt',
           acctest)

periodtrain = accuracyTPeriodTime(indextrain,classesl)
periodtest = accuracyTPeriodTime(indextest,classesl)
np.savetxt(directorydata + 'train_periodaccuracy_ClassCentury_ANNv1.txt',
           periodtrain)
np.savetxt(directorydata + 'test_periodaccuracy_ClassCentury_ANNv1.txt',
           periodtest)
