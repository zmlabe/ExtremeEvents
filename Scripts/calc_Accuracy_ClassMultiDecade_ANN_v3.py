...
### Save statistics
np.savetxt(directorydata + 'train_totalaccuracy_ClassMultiDecade_ANNv3_%s.txt' % dataset,
            np.array([acctrain]))
np.savetxt(directorydata + 'test_totalaccuracy_ClassMultiDecade_ANNv3_%s.txt' % dataset,
            np.array([acctest]))
np.savetxt(directorydata + 'train_periodaccuracy_ClassMultiDecade_ANNv3_%s.txt' % dataset,
            periodtrain)
np.savetxt(directorydata + 'test_periodaccuracy_ClassMultiDecade_ANNv3_%s.txt' % dataset,
            periodtest)