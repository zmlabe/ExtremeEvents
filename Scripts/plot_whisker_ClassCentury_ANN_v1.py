"""
Scipt plots histograms of data with mean removed over 3 time periods
...
num_of_class = 2
iterations = 100
labelx = [r'1920-2009',r'2009-2099']
...
### Second
meantrain3 = np.nanmean(meantrain[-lengthlabels:,1],axis=0)
train35 = np.percentile(meantrain[-lengthlabels:,1],5,axis=0)
train395 = np.percentile(meantrain[-lengthlabels:,1],95,axis=0)
meantest3 = np.nanmean(meantest[-lengthlabels:,1],axis=0)
test35 = np.percentile(meantest[-lengthlabels:,1],5,axis=0)
test395 = np.percentile(meantest[-lengthlabels:,1],95,axis=0)

### Combination of data
total = np.append(train,test,axis=0)

datameantrain = [meantrain1,meantrain3]
datameantest = [meantest1,meantest3]
train5 = [train5,train35]
train95 = [train95,train395]
test5 = [test5,test35]
test95 = [test95,test395]
...
ccc=ww.Aquatic1_5.mpl_colormap(np.linspace(0.2,0.4,len(datameantrain)))
...
plt.xlim([-1,2])
plt.ylim([0,1.0])
plt.savefig(directoryfigure + 'training_2_errorbar-nomean.png',dpi=300)
...
plt.xlim([-1,2])
plt.ylim([0,1.0])
plt.savefig(directoryfigure + 'testing_2_errorbar-nomean.png',dpi=300)