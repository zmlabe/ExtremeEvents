"""
Scipt plots histograms of data with mean removed over 2 time periods
...
plt.xlim([1920,2100])
plt.ylim([0,1.0])
plt.savefig(directoryfigure + 'training_century_2_MPI.png',dpi=300)
...
plt.xlim([1920,2100])
plt.ylim([0,1.0])
plt.savefig(directoryfigure + 'testing_century_2_MPI.png',dpi=300)