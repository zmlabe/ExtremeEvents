...
for sis,singlesimulation in enumerate(datasetsingle):
    ...
    for seas in range(len(seasons)):
        ...
        directoryfigure = '/Users/zlabe/Desktop/ExtremeEvents_v1_VAR/%s/' % simuqq
        ...
        rm_variance_dev = True
        if rm_variance_dev == True:
            directoryfigure = '/Users/zlabe/Desktop/ExtremeEvents_v1_VAR/%s/' % simuqq
        ...
        for avgHalfChunk in (0,): # ([1,5,10]):#([1,2,5,10]):
            ...
            for loop in ([0]): # (0,1,2,3,4,5):
                ...
                for exp in expList:  
                    ...
                    if rm_variance_dev == True:
                        data = dSS.rm_variance_dev(data,window)
        ...
        print(rm_variance_dev,'= rm_variance_dev') 
