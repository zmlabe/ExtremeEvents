...
data1 = Dataset(directorydata + 'LRP_Maps-STDDEV-Monthly%syrs_train_%s_%s_%s_land_only-%s_%s.nc' % (window,monthlychoice,variq,dataset,land_only,reg_name))
...
data2 = Dataset(directorydata + 'LRP_Maps-STDDEV-Monthly%syrs_test_%s_%s_%s_land_only-%s_%s.nc' % (window,monthlychoice,variq,dataset,land_only,reg_name))
